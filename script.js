// Simple To-Do app for students using localStorage
    (function(){
      ...
      function seedIfEmpty(){
        ...
        tasks = [
          { id: uid(), name:'Laporan Praktikum', course:'Desain Web', deadline: nextDate(2), priority:'high', notes:'Analisis fungsi tag', done:false, createdAt: new Date().toISOString()},
          { id: uid(), name:'Presentasi Kelompok', course:'Interaksi Manusia dan Komputer', deadline: nextDate(5), priority:'normal', notes:'Cari judul dan latar belakang', done:true, createdAt: new Date().toISOString()}
        ];
        save();
      }
